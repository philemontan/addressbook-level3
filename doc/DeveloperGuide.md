...
`* *` | user | enter personal short forms of commands | work faster with greater convenience
`* *` | user | add people to a priority list | view people on the priority list by default when list command is called
